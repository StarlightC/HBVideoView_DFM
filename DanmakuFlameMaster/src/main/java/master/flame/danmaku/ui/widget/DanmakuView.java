...
public class DanmakuView extends View implements IDanmakuView, IDanmakuViewController {
    ...
    public boolean isTouchDanmaku(MotionEvent event) {
        return mTouchHelper.isTouchHitDanmaku(event);
    }
    ...
    public IDanmakus getPreAndCurrentDanmakus() {
        if (handler != null) {
            return handler.getPreAndCurrentDanmakus();
        }
        return null;
    }
